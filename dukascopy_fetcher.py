...
try:
    ...
    from dukascopy_python.instruments import (
        ...
        INSTRUMENT_FX_CROSSES_TRY_JPY,
        INSTRUMENT_FX_CROSSES_ZAR_JPY,
        INSTRUMENT_FX_CROSSES_MXN_JPY,
    )
...
if DUKASCOPY_AVAILABLE:
    SYMBOL_MAP = {
        ...
        "NZD_JPY": INSTRUMENT_FX_CROSSES_NZD_JPY,
        "CAD_JPY": INSTRUMENT_FX_CROSSES_CAD_JPY,
        "CHF_JPY": INSTRUMENT_FX_CROSSES_CHF_JPY,
        "TRY_JPY": INSTRUMENT_FX_CROSSES_TRY_JPY,
        "ZAR_JPY": INSTRUMENT_FX_CROSSES_ZAR_JPY,
        "MXN_JPY": INSTRUMENT_FX_CROSSES_MXN_JPY,
